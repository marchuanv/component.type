...
export class ClassFileExport {
    ...
    */
    static exports(classFile) {
        return privateBag.get(ClassFileExport).find(({ pathInfo }) => pathInfo.Id === classFile.pathInfo.Id);
    }
}
privateBag.set(ClassFileExport, []);
import { Reference, ReferenceContext, Reflection } from '../registry.mjs';
export class TypeAssociation extends Reference {
    ...
    */
    static associate(Class, associatedClass) {
        ...
        if (associatedClass === null || associatedClass === undefined || !Reflection.isClass(associatedClass)) {
            throw new Error(`The associatedClass argument is null, undefined or not a class.`);
        }

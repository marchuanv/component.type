...
export class Type extends Namespace{
    ...
    */
    constructor(namespace, target) {
        ...
        if (!namespace.startsWith(Type.namespace)) {
            throw new Error(`namespace argument does not start with ${Type.namespace}.`);
        }
...
new CommonType(Type.namespace, String);
new CommonType(Type.namespace, Boolean);
new CommonType(Type.namespace, BigInt);
new CommonType(Type.namespace, Number);
new CommonType(Type.namespace, Object);
new CommonType(Type.namespace, Array);
new CommonType(Type.namespace, GUID);
new CommonType(Type.namespace, Namespace);
new CommonType(Type.namespace, Set);